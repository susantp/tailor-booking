...
//                $new['popular'] = $v->popular == 0 ? '<span style="color:red">No</span>' : '<span style="color:green">Yes</span>';
    ...
    {
        return $this->hasMany('App\Models\RetailImage', 'aid');
    }

    function form_builder_array($values = array(), $template_data = array())
    {
        $view = \View::make('backend.retail.retail_images', [
            ...
            'group1' => array(
                ...
                'field' => array(
                    ...
                    array('label' => 'Cover Image',
                        ...
                        'placeholder' => "Retail Cover Image",
...
//            ),
    ...
    function get_category_for_dropdown($type_id = 3)
    {
        $record = [];
